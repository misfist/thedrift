...
<section class="cus_post_outer">
	...
	?>
   <h1 id="<?php echo $post->post_name; ?>" class="issue_heading"><strong><?php echo get_the_title(); ?></strong> <br/> 
										   <?php
		...
		foreach ( $sectionLoop as $sectionVal ) {
		  ...
		  <div class="issue_container">		  	
			<div class="cus_post_hea">
				...
				if ( $colorPick != '' ) {
					?>
 color:  <?php echo $colorPick; } ?>"><?php echo $section_name; ?></h6>
			</div>
		...
		<style type="text/css">
			...
			<div class="com_heading01" id="id_<?php echo $loopNum_test; ?>">  
				<h4>
					<a href="<?php echo $issuePermalink; ?>" ><b><?php echo $articleValue['title_acf']; ?></b>​<span class="issues_pipe" style=" 
                        <?php
                        if ( $colorPick != '' ) {
                            ?>
                        color:  <?php echo $colorPick; } ?>">|</span><?php echo $articleValue['subtitle_acf']; ?></a></h4>
                        ...
                        <div class="authors">
                            ...
                            foreach ( $post_authors as $post_author ) {
                                ...
                                if ( $loopNum == 1 ) {
                                    ?>
                                    <a href="<?php echo $issuePermalink; ?>"><?php echo $author_name; ?></a>
                                    <?php
                                } else {
                                    ?>
                                    <a href="<?php echo $issuePermalink; ?>"><?php echo $author_name; ?></a>
